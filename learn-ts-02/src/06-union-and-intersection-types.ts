...
// console.log(OneThroughFive); //!OneThroughFive only refers to a type, but is being used as a value here.
...
console.log(`evenOrLowNumber: ${evenOrLowNumber}`);
...
// //     ^? "heads" | "tails"
console.log(` ^? "heads" | "tails" -- ${outcome}`);
...
console.log(`outcome2 only print Name: ${outcome2[1].name}`);
